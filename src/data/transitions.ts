...
export const transitions: TransitionEntry[] = [
  ...
  // Big-moment
  {
    ...
    name: "Double Drop",
    category: "drop",
    description: "Times the incoming track's drop to land at the exact moment the outgoing track hits its own drop — the two hit together, signature EDM-set move. Uses each track's single best-effort detected drop moment.",
    idealBpmDeltaMax: 0.08,
  ...
  },
  {
    ...
    name: "Drop Swap",
    category: "drop",
    description: "The same Double Drop idea, locked to a real Hot Cue (Drop 1/Drop 2) placed — auto-detected or by hand — on both tracks, instead of one unconfirmed guess. Only ever picked when both decks actually have one.",
    idealBpmDeltaMax: 0.08,
    idealGenres: ["dubstep", "hardstyle", "dnb"],
    executable: true,
    exampleDjs: ["Skrillex", "Excision"],
